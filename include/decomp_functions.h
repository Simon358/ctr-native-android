...
void DECOMP_RECTMENU_DrawPolyGT4(struct Icon *icon, short posX, short posY, struct PrimMem *primMem, u_long *ot, u_int color0, u_int color1, u_int color2,
                                 u_int color3, char transparency, short scale);
...
void DECOMP_MM_Battle_DrawIcon_Weapon(struct Icon *icon, u_int posX, int posY, struct PrimMem *primMem, u_int *ot, char transparency, short param_7,
                                      u_short param_8, u_int *color);
...
void DECOMP_AH_Map_LoadSave_Prim(short *vertPos, char *vertCol, void *ot, struct PrimMem *primMem);

void DECOMP_AH_Map_LoadSave_Full(int posX, int posY, short *vertPos, char *vertCol, int unk800, int angle);
...
void DECOMP_UI_Map_DrawRawIcon( // 1st param is probably a ptr type of some sort (maybe short*)?, could maybe do `void*` for now
    int ptrMap, int *param_2, int iconID, int colorID, int unused, short scale);
